...
func TestAccVirtualRouterStaticRoutesIpv6(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: virtualRouterStaticRoutesIpv6Tmpl1,
				...
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(
						"panos_virtual_router_static_routes_ipv6.example",
						tfjsonpath.New("virtual_router"),
						knownvalue.StringExact(fmt.Sprintf("%s-vr1", prefix)),
					),
					statecheck.ExpectKnownValue(
						"panos_virtual_router_static_routes_ipv6.example2",
						tfjsonpath.New("virtual_router"),
			...
			{
				Config: virtualRouterStaticRoutesIpv6Tmpl2,
				ConfigVariables: map[string]config.Variable{
					"location": location,
					"prefix":   config.StringVariable(prefix),
				},
...
const virtualRouterStaticRoutesIpv6Tmpl1 = `
...
const virtualRouterStaticRoutesIpv6Tmpl2 = `
variable "location" { type = any }
variable "prefix" { type = string }
