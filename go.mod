...
require (
	github.com/PaloAltoNetworks/pango v0.10.3-0.20250606105841-b2f576a01f95
...
require (
	...
	github.com/hashicorp/terraform-json v0.24.1-0.20250314103308-f86d5e36f4ab // indirect
