...
func resourcePanoramaSecurityPolicies() *schema.Resource {
	return &schema.Resource{
		Create: createUpdatePanoramaSecurityPolicies,
		Read:   readPanoramaSecurityPolicies,
...
func parsePanoramaSecurityPolicies(d *schema.ResourceData) (string, string, []security.Entry) {
...
func parsePanoramaSecurityPoliciesId(v string) (string, string) {
	t := strings.Split(v, IdSeparator)
	return t[0], t[1]
}

func buildPanoramaSecurityPoliciesId(a, b string) string {
	return fmt.Sprintf("%s%s%s", a, IdSeparator, b)
}

func createUpdatePanoramaSecurityPolicies(d *schema.ResourceData, meta interface{}) error {
	var err error
	...
	d.SetId(buildPanoramaSecurityPoliciesId(dg, rb))
	return readPanoramaSecurityPolicies(d, meta)
}

func readPanoramaSecurityPolicies(d *schema.ResourceData, meta interface{}) error {
	var err error

	pano := meta.(*pango.Panorama)
	dg, rb := parsePanoramaSecurityPoliciesId(d.Id())
...
func deletePanoramaSecurityPolicies(d *schema.ResourceData, meta interface{}) error {
	pano := meta.(*pango.Panorama)
	dg, rb := parsePanoramaSecurityPoliciesId(d.Id())
