---
page_title: "panos_ospfv3_spf_timer_routing_profile Data Source - panos"
subcategory: "Network"
description: |-
  
---

# panos_ospfv3_spf_timer_routing_profile (Data Source)
...
- `initial_hold_time` (Number) Initial hold time (second) between consecutive SPF calculations
- `lsa_interval` (Number) The minimum time in seconds between distinct originations of any particular LSA
- `max_hold_time` (Number) Maximum hold time (second)
