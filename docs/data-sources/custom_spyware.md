---
page_title: "panos_custom_spyware Data Source - panos"
subcategory: "Objects"
description: |-
  
---

# panos_custom_spyware (Data Source)
...
- `threatname` (String) alphanumeric string [ 0-9a-zA-Z._-]
...
- `alert` (Attributes) (see [below for nested schema](#nestedatt--default_action--alert))
- `allow` (Attributes) (see [below for nested schema](#nestedatt--default_action--allow))
- `block_ip` (Attributes) (see [below for nested schema](#nestedatt--default_action--block_ip))
- `drop` (Attributes) (see [below for nested schema](#nestedatt--default_action--drop))
- `reset_both` (Attributes) (see [below for nested schema](#nestedatt--default_action--reset_both))
- `reset_client` (Attributes) (see [below for nested schema](#nestedatt--default_action--reset_client))
- `reset_server` (Attributes) (see [below for nested schema](#nestedatt--default_action--reset_server))
...
- `operator` (Attributes) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator))
...
- `equal_to` (Attributes) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--equal_to))
- `greater_than` (Attributes) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--greater_than))
- `less_than` (Attributes) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--less_than))
- `pattern_match` (Attributes) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--pattern_match))
...
- `context` (String)
- `negate` (Boolean)
- `qualifier` (Attributes List) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--equal_to--qualifier))
- `value` (Number)
...
- `context` (String)
- `qualifier` (Attributes List) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--greater_than--qualifier))
- `value` (Number)
...
- `context` (String)
- `qualifier` (Attributes List) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--less_than--qualifier))
- `value` (Number)
...
- `negate` (Boolean)
- `pattern` (String)
- `qualifier` (Attributes List) (see [below for nested schema](#nestedatt--signature--standard--and_condition--or_condition--operator--pattern_match--qualifier))
