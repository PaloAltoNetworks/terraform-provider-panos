...
func (c *FwExp) versioning() (normalizer, func(Entry) (interface{})) {
    v := c.con.Versioning()
...
func (c *FwExp) details(fn util.Retriever, vr, name string) (Entry, error) {
...
func (c *FwExp) xpath(vr string, vals []string) []string {
    return []string{
        "config",
        "devices",
