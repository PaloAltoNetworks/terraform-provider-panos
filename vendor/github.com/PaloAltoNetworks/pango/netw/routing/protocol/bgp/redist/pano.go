...
func (c *PanoRedist) versioning() (normalizer, func(Entry) (interface{})) {
    v := c.con.Versioning()
...
func (c *PanoRedist) details(fn util.Retriever, tmpl, ts, vr, name string) (Entry, error) {
...
func (c *PanoRedist) xpath(tmpl, ts, vr string, vals []string) []string {
