...
func (c *FwDampening) versioning() (normalizer, func(Entry) (interface{})) {
    return &container_v1{}, specify_v1
}

func (c *FwDampening) details(fn util.Retriever, vr, name string) (Entry, error) {
...
func (c *FwDampening) xpath(vr string, vals []string) []string {
    return []string{
        "config",
        "devices",
