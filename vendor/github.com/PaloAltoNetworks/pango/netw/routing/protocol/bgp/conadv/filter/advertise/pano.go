...
func (c *PanoAdvertise) details(fn util.Retriever, tmpl, ts, vr, ca, name string) (Entry, error) {
...
func (c *PanoAdvertise) xpath(tmpl, ts, vr, ca string, vals []string) []string {
