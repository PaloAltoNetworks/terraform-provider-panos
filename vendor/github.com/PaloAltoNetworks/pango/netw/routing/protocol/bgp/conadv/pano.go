...
func (c *PanoConAdv) versioning() (normalizer, func(Entry) (interface{})) {
    return &container_v1{}, specify_v1
}

func (c *PanoConAdv) details(fn util.Retriever, tmpl, ts, vr, name string) (Entry, error) {
...
func (c *PanoConAdv) xpath(tmpl, ts, vr string, vals []string) []string {
