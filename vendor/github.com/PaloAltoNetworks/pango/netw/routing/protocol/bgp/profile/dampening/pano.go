...
func (c *PanoDampening) Set(tmpl, ts, vr string, e ...Entry) error {
    ...
    // Build up the struct.
    d := util.BulkElement{XMLName: xml.Name{Local: "dampening-profile"}}
    for i := range e {
...
func (c *PanoDampening) versioning() (normalizer, func(Entry) (interface{})) {
    return &container_v1{}, specify_v1
}

func (c *PanoDampening) details(fn util.Retriever, tmpl, ts, vr, name string) (Entry, error) {
...
func (c *PanoDampening) xpath(tmpl, ts, vr string, vals []string) []string {
