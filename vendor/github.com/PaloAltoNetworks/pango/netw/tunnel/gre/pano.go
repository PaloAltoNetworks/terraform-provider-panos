...
func (c *PanoGre) versioning() (normalizer, func(Entry) interface{}) {
	return &container_v1{}, specify_v1
}

func (c *PanoGre) details(fn util.Retriever, tmpl, ts, name string) (Entry, error) {
...
func (c *PanoGre) xpath(tmpl, ts string, vals []string) []string {
