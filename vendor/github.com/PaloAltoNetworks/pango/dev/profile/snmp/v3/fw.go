...
func (c *FwV3) versioning() (normalizer, func(Entry) interface{}) {
	return &container_v1{}, specify_v1
}

func (c *FwV3) details(fn util.Retriever, vsys, profile, name string) (Entry, error) {
...
func (c *FwV3) xpath(vsys, profile string, vals []string) []string {
	if vsys == "" {
		vsys = "shared"
	}
