...
func (c *PanoV3) versioning() (normalizer, func(Entry) (interface{})) {
    return &container_v1{}, specify_v1
}

func (c *PanoV3) details(fn util.Retriever, tmpl, ts, vsys, dg, profile, name string) (Entry, error) {
...
func (c *PanoV3) xpath(tmpl, ts, vsys, dg, profile string, vals []string) []string {
    var ans []string
