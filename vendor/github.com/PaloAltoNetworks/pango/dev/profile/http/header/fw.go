...
func (c *FwHeader) versioning() (normalizer, func(Entry) interface{}) {
	return &container_v1{}, specify_v1
}

func (c *FwHeader) details(fn util.Retriever, vsys, profile, logtype, name string) (Entry, error) {
...
func (c *FwHeader) xpath(vsys, profile, logtype string, vals []string) []string {
	if vsys == "" {
		vsys = "shared"
	}
