...
func (c *FwEmail) versioning() (normalizer, func(Entry) interface{}) {
	v := c.con.Versioning()
...
func (c *FwEmail) details(fn util.Retriever, vsys, name string) (Entry, error) {
...
func (c *FwEmail) xpath(vsys string, vals []string) []string {
	if vsys == "" {
		vsys = "shared"
	}
