...
func (c *FwSyslog) versioning() (normalizer, func(Entry) interface{}) {
	v := c.con.Versioning()
...
func (c *FwSyslog) details(fn util.Retriever, vsys, name string) (Entry, error) {
...
func (c *FwSyslog) xpath(vsys string, vals []string) []string {
	if vsys == "" {
		vsys = "shared"
	}
