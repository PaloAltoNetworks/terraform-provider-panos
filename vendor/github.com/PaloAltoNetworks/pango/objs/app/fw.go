...
func (c *FwApp) versioning() (normalizer, func(Entry) interface{}) {
	v := c.con.Versioning()
...
func (c *FwApp) details(fn util.Retriever, vsys, name string) (Entry, error) {
...
func (c *FwApp) xpath(vsys string, vals []string) []string {
	ans := make([]string, 0, 7)
