...
/** Internal functions for the PanoSrvcGrp struct **/

func (c *PanoSrvcGrp) versioning() (normalizer, func(Entry) (interface{})) {
    return &container_v1{}, specify_v1
}

func (c *PanoSrvcGrp) details(fn util.Retriever, dg, name string) (Entry, error) {
...
func (c *PanoSrvcGrp) xpath(dg string, vals []string) []string {
    if dg == "" {
        dg = "shared"
    }
