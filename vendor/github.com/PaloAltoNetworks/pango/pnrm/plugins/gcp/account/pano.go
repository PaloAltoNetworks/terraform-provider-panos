...
func (c *Account) versioning() (normalizer, func(Entry) interface{}) {
	return &container_v1{}, specify_v1
}

func (c *Account) details(fn util.Retriever, name string) (Entry, error) {
...
func (c *Account) xpath(vals []string) []string {
	return []string{
		"config",
		"devices",
